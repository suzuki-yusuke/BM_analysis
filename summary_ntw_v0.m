function [] = summary_ntw_v0(parameters,options,tbl)

%%
fprintf('\nAnalyze network indices......DONE\n')
ntwObj = analyze_ntw_med_170215(parameters, tbl);

if options.order{'Network','Stats'}
    stats_ntw_v0(tbl,ntwObj,parameters)
end
...
if options.order{'Network','View'}
    FigMaker_ntw_v0(tbl, ntwObj, parameters, options)
    fprintf('\nVisualize......DONE\n')
else
    fprintf('\nVisualize......SKIP\n')
end